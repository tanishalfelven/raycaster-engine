...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib_math_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/math/point */ \"./src/lib/math/point.js\");\n/* harmony import */ var _lib_math_section__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./lib/math/section */ \"./src/lib/math/section.js\");\n/* harmony import */ var _lib_math_line__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./lib/math/line */ \"./src/lib/math/line.js\");\n/* harmony import */ var _lib_math_ray__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./lib/math/ray */ \"./src/lib/math/ray.js\");\n/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./lib/util */ \"./src/lib/util.js\");\n\n\n\n\n\n\nconst csl = {\n    bgWhite : \"\\x1b[47m\",\n    bgBlack : \"\\x1b[40m\",\n\n    fgBlack : \"\\x1b[30m\",\n    fgWhite : \"\\x1b[37m\",\n    fgGreen : \"\\x1b[32m\",\n    fgRed   : \"\\x1b[31m\"\n};\n\n// TODO add test dependency\nconst test = {\n    add(tests) {\n        this.tests = tests;\n        this.output();\n    },\n\n    output() {\n        let passed = 0, failed = 0, grp = \"\", offset = 0;\n        console.log(`\\n${csl.bgWhite + csl.fgBlack}--Running tests--${csl.bgBlack + csl.fgWhite}`);\n        this.tests.forEach((test, i) => {\n            if (typeof test !== \"string\" && test.length === 2) {\n                grp = test[1];\n                test = test[0];\n                offset = i;\n            }\n            console.log(`  [${test ? csl.fgGreen + \"PASS\" : csl.fgRed + \"FAIL\"}${csl.fgWhite}] : ${grp}-${i - offset + 1}`);\n            if (test) passed++;\n            else failed++;\n        });\n\n        console.log(`finished: ${csl.fgRed + failed} failed${csl.fgWhite}, ${csl.fgGreen + passed} passed${csl.fgWhite}, ${this.tests.length} ran`);\n    }\n}\n\nfunction intersect(rayx, rayy, rayrot, lax, lay, lbx, lby) {\n    return new _lib_math_ray__WEBPACK_IMPORTED_MODULE_3__[\"default\"](rayx, rayy, rayrot).intersectsLine(new _lib_math_line__WEBPACK_IMPORTED_MODULE_2__[\"default\"](new _lib_math_point__WEBPACK_IMPORTED_MODULE_0__[\"default\"](lax, lay), new _lib_math_point__WEBPACK_IMPORTED_MODULE_0__[\"default\"](lbx, lby)));\n}\n\ntest.add([\n    [intersect(0, 0, 0, 1, 5, 1, -5), \"a\"],\n    intersect(0, 0, _lib_util__WEBPACK_IMPORTED_MODULE_4__[\"default\"].toRadians(180), 1, 5, 1, -5),\n    intersect(0, 0, _lib_util__WEBPACK_IMPORTED_MODULE_4__[\"default\"].toRadians(90), 1, 5, 1, -5),\n    intersect(0, 0, _lib_util__WEBPACK_IMPORTED_MODULE_4__[\"default\"].toRadians(270), 1, 5, 1, -5),\n    \n    [intersect(0, 0, 0, 1,-5, 1, 5), \"b\"],\n    [intersect(0, 0, _lib_util__WEBPACK_IMPORTED_MODULE_4__[\"default\"].toRadians(90), -5, 5, 5, 5), \"c\"],\n]);\n\n\n//# sourceURL=webpack:///./src/test.js?");
